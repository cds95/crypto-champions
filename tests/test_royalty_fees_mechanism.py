...
def test_royalty_paid_out(accounts, crypto_champions, mint_first_elder, fund_contract_with_link):
...
def test_elder_ownership_transfer_royalty(accounts, crypto_champions, mint_first_elder, fund_contract_with_link):
